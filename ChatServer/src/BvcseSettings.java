    ...
    implements ActionListener, KeyListener, WindowListener
{
	...
	passwordWarningLabel1.setVisible(parentWindow.requirePassword &&
				    ...
				    .canEncrypt);
	passwordWarningLabel1.setFont(BvcseWindow.XsmallFont);
	...
	passwordWarningLabel2.setVisible(parentWindow.requirePassword &&
				    !parentWindow.passwordEncryptor
				    .canEncrypt);
	passwordWarningLabel2.setFont(BvcseWindow.XsmallFont);
	...
	passwordWarningLabel3.setVisible(parentWindow.requirePassword &&
				    !parentWindow.passwordEncryptor
				    .canEncrypt);
	passwordWarningLabel3.setFont(BvcseWindow.XsmallFont);
	...
	portLabel2.setFont(BvcseWindow.XsmallFont);
