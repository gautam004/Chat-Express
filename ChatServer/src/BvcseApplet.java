...
public class BvcseApplet
    extends Applet
{
    // This is just a simple applet wrapper class to allow Bvcse Chat
    ...
    {
	return ("Bvcse Chat version " + Bvcse.VERSION
		+ " by Andy McLaughlin");
    }
	...
	String[][] args = {
	    ...
	    { servernameParam, "string",
	      "Internet hostname/address of Bvcse Chat server" },
	...
	window = new BvcseWindow(name, password, host, port, showCanvas,
				   getCodeBase());
