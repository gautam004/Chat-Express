    ...
    implements ActionListener, ItemListener, KeyListener, WindowListener
{
    ...
    private boolean userInRoom(String userName, BvcseRoomInfo room)
    {
	...
	BvcseRoomInfo currentRoom = parentWindow.currentRoom;
	...
	for (int count = 0; count < usersVector.size(); count ++)
	    {
		BvcseUser user = (BvcseUser) usersVector.elementAt(count);
