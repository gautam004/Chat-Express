    ...
    implements Runnable
{
	...
	for (int count = 0; count < args.length; count ++)
		...
		if (args[count].equals(usernameParam))
		    ...
		    {
			System.out.println("\nBvcse: unknown argument "
					   + args[count]);
			System.out.println("Type 'java Bvcse -help' for "
					   + "usage information");
			return (false);
		    }
	    }
    ...
    {
	Bvcse firstinstance = new Bvcse(args);
	firstinstance.run();
	return;
    }

    public Bvcse(String[] args)
    {
