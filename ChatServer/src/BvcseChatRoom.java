...
public class BvcseChatRoom
{
    // This class is used to manage chat rooms.  It's defined in its own
    // source file because it is used by both the Bvcseserver and
    // BvcseClientSocket classes
    ...
    BvcseChatRoom(String myName, String myCreator, boolean isPrivate,
		    String myPassword)
    {
	name = myName;
    ...
    public void addClient(BvcseClientSocket newClient)
    {
    ...
    public void remClient(BvcseClientSocket oldClient)
    {
