...
public class BvcseUserToolDialog
    extends Dialog
    implements ActionListener, ItemListener, KeyListener, WindowListener
{
    private BvcseUserTool userTool = new BvcseUserTool();

    protected BvcseServerWindow parentWindow;
    ...
    public BvcseUserToolDialog(BvcseServerWindow parent)
    {
	...
	String encryptedPassword = new BvcsePasswordEncryptor()
	...
	try {
	    ...
	    new BvcseInfoDialog(parentWindow, "Error creating user",
				  true, e.toString());
	    return;
	}
	...
	for (int count = 0; count < users.length; count ++)
		...
		try {
		    ...
		    new BvcseInfoDialog(parentWindow, "Error deleting user",
					  true, e.toString());
		    return;
		}
	    }
